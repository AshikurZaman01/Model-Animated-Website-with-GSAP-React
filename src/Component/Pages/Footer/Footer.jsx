        ...
        <div className="w-full h-screen bg-zinc-900 p-20 flex justify-between">
            ...
            <div className="w-1/2 font-founders flex flex-col justify-between h-full">
                ...
                <div className="heading">
                    ...
                    <h1 className="text-[8vw] font-semibold uppercase leading-none -mb-10 text-zinc-100">opening</h1>
                </div>
            ...
            <div className="w-1/2 font-founders">
                <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-10 text-zinc-100">presentations</h1>
